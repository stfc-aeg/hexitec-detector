...
class LiveViewAdapter(ApiAdapter):
    ...
    def __init__(self, **kwargs):
        ...
        logging.getLogger('matplotlib.font_manager').disabled = True  # Prevent spam to log
...
class LiveViewer(object):
    ...
    def set_bin_start(self, bin_start):
        """
        Set the bin_start histogram value.

        :param bin_start: bin_start integer value
        """
        self.bin_start = bin_start

    def set_bin_end(self, bin_end):
        """
        Set the bin_end histogram value.

        :param bin_end: bin_end integer value
        """
        self.bin_end = bin_end

    def set_bin_width(self, bin_width):
        """
        Set the bin_width histogram value.

        :param bin_width: bin_width float value
        """
        self.bin_width = bin_width

    def recalculate_bins(self):
        """Recalculate number of histogram bins."""
        self.number_bins = round(((self.bin_end - self.bin_start) / self.bin_width))
