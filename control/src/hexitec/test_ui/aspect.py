...
class Hexitec2x6():
    ...
    def expand_addresses(self, number_registers, address_h, address_l):
        """Expands addresses by the number_registers specified.
...
# # 90	42	01	01	;Disable SM # SET BIT
        ...
        hxt.write_and_response(vsr, 0x30, 0x32, 0x30, 0x31) # LowByte Row S1
        """
        90	42	04	01	;S1Sph
        90	42	05	06	;SphS2
        ...
        """
        hxt.write_and_response(vsr, 0x30, 0x34, 0x30, 0x31) # S1Sph
        hxt.write_and_response(vsr, 0x30, 0x35, 0x30, 0x36) # SphS2
