...
def set_up_state_machine():
    ...
    sm_timing2 = [0x23, tk.vsr_addr, 0x42, 0x30, 0x32, 0x30, 0x31, 0x0D]  # Faster
    # sm_timing2 = [0x23, tk.vsr_addr, 0x42, 0x30, 0x32, 0x46, 0x34, 0x0D]  # Slower
...
def load_pwr_cal_read_enables():
    ...
    col_read_enable1 = [0x23, tk.vsr_addr, 0x44, 0x36, 0x31, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                        0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                        0x46, 0x46, 0x0D]
    col_read_enable2 = [0x23, tk.vsr_addr, 0x44, 0x43, 0x32, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                        0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                        0x46, 0x46, 0x0D]
    col_power_enable1 = [0x23, tk.vsr_addr, 0x44, 0x34, 0x44, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                         0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                         0x46, 0x46, 0x0D]
    col_power_enable2 = [0x23, tk.vsr_addr, 0x44, 0x41, 0x45, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                         0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                         0x46, 0x46, 0x0D]

    # JE orgin:
    col_cal_enable1a = [0x23, tk.vsr_addr, 0x44, 0x35, 0x37, 0x46, 0x46, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]
    # 30/07 JE alt:
    col_cal_enable1a = [0x23, tk.vsr_addr, 0x44, 0x35, 0x37, 0x46, 0x46, 0x46, 0x46, 0x30, 0x30,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]

    col_cal_enable1b = [0x23, tk.vsr_addr, 0x44, 0x35, 0x37, 0x30, 0x30, 0x30, 0x30, 0x46, 0x30,
                        0x30, 0x46, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]
    col_cal_enable1c = [0x23, tk.vsr_addr, 0x44, 0x35, 0x37, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x46, 0x46, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]
    # Uncalibrated(Image4) column option:
    col_cal_enable1d = [0x23, tk.vsr_addr, 0x44, 0x35, 0x37, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]

    # JE orgin:
    col_cal_enable2a = [0x23, tk.vsr_addr, 0x44, 0x42, 0x38, 0x46, 0x46, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]
    # 30/07 alt:
    col_cal_enable2a = [0x23, tk.vsr_addr, 0x44, 0x42, 0x38, 0x46, 0x46, 0x46, 0x46, 0x30, 0x30,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]

    col_cal_enable2b = [0x23, tk.vsr_addr, 0x44, 0x42, 0x38, 0x30, 0x30, 0x30, 0x30, 0x46, 0x30,
                        0x30, 0x46, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]
    col_cal_enable2c = [0x23, tk.vsr_addr, 0x44, 0x42, 0x38, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x46, 0x46, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]
    # Uncalibrated(Image4) column option:
    col_cal_enable2d = [0x23, tk.vsr_addr, 0x44, 0x42, 0x38, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]

    row_read_enable1 = [0x23, tk.vsr_addr, 0x44, 0x34, 0x33, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                        0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                        0x46, 0x46, 0x0D]
    row_read_enable2 = [0x23, tk.vsr_addr, 0x44, 0x41, 0x34, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                        0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                        0x46, 0x46, 0x0D]
    row_power_enable1 = [0x23, tk.vsr_addr, 0x44, 0x32, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                         0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                         0x46, 0x46, 0x0D]
    row_power_enable2 = [0x23, tk.vsr_addr, 0x44, 0x39, 0x30, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                         0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46, 0x46,
                         0x46, 0x46, 0x0D]

    # JE original:
    row_cal_enable1a = [0x23, tk.vsr_addr, 0x44, 0x33, 0x39, 0x30, 0x30, 0x46, 0x46, 0x30, 0x30,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]
    # 30/07 JE alt:
    row_cal_enable1a = [0x23, tk.vsr_addr, 0x44, 0x33, 0x39, 0x30, 0x30, 0x30, 0x30, 0x46, 0x46,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]

    row_cal_enable1b = [0x23, tk.vsr_addr, 0x44, 0x33, 0x39, 0x30, 0x30, 0x46, 0x46, 0x30, 0x30,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]
    row_cal_enable1c = [0x23, tk.vsr_addr, 0x44, 0x33, 0x39, 0x30, 0x30, 0x46, 0x46, 0x30, 0x30,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]
    # Uncalibrated(Image4) row option:
    row_cal_enable1d = [0x23, tk.vsr_addr, 0x44, 0x33, 0x39, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]

    # JE original:
    row_cal_enable2a = [0x23, tk.vsr_addr, 0x44, 0x39, 0x41, 0x30, 0x30, 0x46, 0x46, 0x30, 0x30,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]
    # 30/07 JE alt:
    row_cal_enable2a = [0x23, tk.vsr_addr, 0x44, 0x39, 0x41, 0x30, 0x30, 0x30, 0x30, 0x46, 0x46,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]

    row_cal_enable2b = [0x23, tk.vsr_addr, 0x44, 0x39, 0x41, 0x30, 0x30, 0x46, 0x46, 0x30, 0x30,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]
    row_cal_enable2c = [0x23, tk.vsr_addr, 0x44, 0x39, 0x41, 0x30, 0x30, 0x46, 0x46, 0x30, 0x30,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]
    # Uncalibrated(Image4) row option:
    row_cal_enable2d = [0x23, tk.vsr_addr, 0x44, 0x39, 0x41, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]

    col_cal_enable1a = [0x23, tk.vsr_addr, 0x44, 0x35, 0x37, 0x46, 0x30, 0x46, 0x46, 0x46, 0x46,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]
    col_cal_enable2a = [0x23, tk.vsr_addr, 0x44, 0x42, 0x38, 0x46, 0x30, 0x46, 0x46, 0x46, 0x46,
                        0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30,
                        0x30, 0x30, 0x0D]
...
def write_dac_values():
    ...
    send_cmd([0x23, tk.vsr_addr, 0x54, 0x30, 0x32, 0x41, 0x41, 0x30, 0x35, 0x35, 0x35, 0x30,
             0x35, 0x35, 0x35, 0x30, 0x30, 0x30, 0x30, 0x30, 0x38, 0x45, 0x38, 0x0D])
    read_response()
...
variable2.set(IMAGE[0])
variable3 = tk.StringVar(frame)
variable3.set(SETCLR[0])
variable4 = tk.StringVar(frame)
variable4.set(REGADDRMSB[2])
variable5 = tk.StringVar(frame)
variable5.set(REGADDRLSB[4])
variable6 = tk.StringVar(frame)
variable6.set(BITVALUE[0])
variable7 = tk.StringVar(frame)
variable7.set(DARKCORRECTION[0])
variable8 = tk.StringVar(frame)
variable8.set(READOUTMODE[1])
variable9 = tk.StringVar(frame)
variable9.set(TESTMODEIMAGE[0])
...
button0 = tk.Button(frame, text="CONNECT", fg="green", command=cam_connect)
button0.pack(side=tk.BOTTOM)

button101 = tk.Button(frame, text="INIT_SYSTEM", fg="CYAN", command=initialise_system)
button101.pack(side=tk.BOTTOM)

button2 = tk.Button(frame, text="INITIALISE", fg="red", command=initialise_sensor)
button2.pack(side=tk.BOTTOM)
button7 = tk.Button(frame, text="LOAD PWR/CAL/READ ENABLES", fg="red", command=load_pwr_cal_read_enables)
button7.pack(side=tk.BOTTOM)
button6 = tk.Button(frame, text="SET UP SM", fg="red", command=set_up_state_machine)
button6.pack(side=tk.BOTTOM)
button8 = tk.Button(frame, text="WRITE DAC VALUES", fg="red", command=write_dac_values)
button8.pack(side=tk.BOTTOM)
button9 = tk.Button(frame, text="ENABLE ADC", fg="red", command=enable_adc)
button9.pack(side=tk.BOTTOM)
button10 = tk.Button(frame, text="ENABLE ADC TESTMODE", fg="red", command=enable_adc_testmode)
button10.pack(side=tk.BOTTOM)
button4 = tk.Button(frame, text="CALIBRATE", fg="red", command=calibrate_sensor)
...
entry_2.pack()
button5 = tk.Button(frame, text="AQUIRE DATA", fg="red", command=acquire_data)
button5.pack(side=tk.BOTTOM)

button1 = tk.Button(frame, text="DISS-CONNECT", fg="red", command=cam_disconnect)
button1.pack(side=tk.BOTTOM)

button12 = tk.Button(frame, text="MODIFY_REGISTER", fg="green", command=modify_register)
# button12["state"] = "disabled"
button12.pack(side=tk.BOTTOM)
button13 = tk.Button(frame, text="READ VOLTAGES", fg="green")
