"""
A copy of Hexitec1x1Producer.py to test out Source_code.py.

Replicated on July 07, 2022
...
if __name__ == '__main__':
    original_stdout = sys.stdout   # Original stream probably not needed, but just in case..
    sequence_file = open("Source_sequence.txt", "w")
    sys.stdout = sequence_file
