"""Show what the encoded values of a few decimal umid values.
...
def convert_aspect_exponent_to_dac_value(exponent):
    """Convert aspect formats to fit dac format.
...
def t(umid_value):
    """Turn umid value into equivalent comma separated string."""
