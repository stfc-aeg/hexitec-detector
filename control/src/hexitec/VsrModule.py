...
def set_row_column_mask(all_elements=True, max_elements=80, reg_size=8):
    """Generates a mask to set the selected elements of a `Hexitec` Row or Column.

    Args:
        all_elements (:obj:`bool`, optional): Sets all bits in the generated mask. Default: `True`.
...
def clr_row_column_mask(all_elements=True, max_elements=80, reg_size=8):
    """Generates a mask to clear the selected elements of a `Hexitec` Row or Column.
...
class VsrAssembly(object):
    ...
    def _fpga_reg_read(self, fgpa_reg_addr):
        ...
        resp = self._rdma_ctrl_iface.uart_read(cmd_no=self.cmd_no)
        if resp:
    ...
    def _uart_write(self, vsr_a, vsr_cmd, wr_d):
        ...
        self._rdma_ctrl_iface.uart_write(wr_cmd, cmd_no=self.cmd_no)
    ...
    def _get_status(self, vsr_mod=None, hv=False, all_vsrs=False):
        ...
        vsr_ctrl_reg = self._rdma_ctrl_iface.udp_rdma_read(HEXITEC_2X6_VSR_CTRL['addr'],
                                                           burst_len=1, cmd_no=self.cmd_no,
...
class VsrModule(VsrAssembly):
    ...
    def _write_high_gain(self):
        ctrl_reg = clr_field(VSR_FPGA_REGISTERS.REG6, "GAIN_SEL", self.read_gain())
        self._fpga_reg_write(VSR_FPGA_REGISTERS.REG6['addr'], ctrl_reg)

    def _write_low_gain(self):
        ctrl_reg = set_field(VSR_FPGA_REGISTERS.REG6, "GAIN_SEL", self.read_gain(), 1)
        self._fpga_reg_write(VSR_FPGA_REGISTERS.REG6['addr'], ctrl_reg)
    ...
    def set_sm_row_wait_clock(self, val):
        """Sets the value of `State-Machine Row Wait Clock` to either of the :attr:`sm_row_wait_clock` attribute.
    ...
    def select_internal_sync_clock(self):
        ...
        Returns:
            Nothing.
        """
        ctrl_reg = clr_field(VSR_FPGA_REGISTERS.REG1, "SYNC_CLK_SEL",
    ...
    def select_external_sync_clock(self):
        ...
        Returns:
            Nothing.
        """
        ctrl_reg = set_field(VSR_FPGA_REGISTERS.REG1, "SYNC_CLK_SEL",
    ...
    def deassert_serial_iface_rst(self):
        ...
        Returns:
            Nothing.
        """
        ctrl_reg = clr_field(VSR_FPGA_REGISTERS.REG1, "SERIAL_IFACE_RST",
                             self._fpga_reg_read(VSR_FPGA_REGISTERS.REG1['addr']))
        self._fpga_reg_write(VSR_FPGA_REGISTERS.REG1['addr'], ctrl_reg)
    ...
    def assert_serial_iface_rst(self):
        ...
        Returns:
            Nothing.
        """
        ctrl_reg = set_field(VSR_FPGA_REGISTERS.REG1, "SERIAL_IFACE_RST",
                             self._fpga_reg_read(VSR_FPGA_REGISTERS.REG1['addr']), 1)
        self._fpga_reg_write(VSR_FPGA_REGISTERS.REG1['addr'], ctrl_reg)
    ...
    def disable_training(self):
        ...
        Returns:
            Nothing.
        """
        ctrl_reg = clr_field(VSR_FPGA_REGISTERS.REG1, "TRAINING_PATTERN_EN",
                             self._fpga_reg_read(VSR_FPGA_REGISTERS.REG1['addr']))
        self._fpga_reg_write(VSR_FPGA_REGISTERS.REG1['addr'], ctrl_reg)
    ...
    def enable_training(self):
        ...
        Returns:
            Nothing.
        """
        ctrl_reg = set_field(VSR_FPGA_REGISTERS.REG1, "TRAINING_PATTERN_EN",
                             self._fpga_reg_read(VSR_FPGA_REGISTERS.REG1['addr']), 1)
        self._fpga_reg_write(VSR_FPGA_REGISTERS.REG1['addr'], ctrl_reg)
    ...
    def enable_plls(self, pll=True, adc_pll=True):
        ...
        if pll:
            ctrl_reg = set_field(VSR_FPGA_REGISTERS.REG7, "ENABLE_PLL", ctrl_reg, 1)
        if adc_pll:
            ctrl_reg = set_field(VSR_FPGA_REGISTERS.REG7, "ENABLE_ADC_PLL", ctrl_reg, 1)
    ...
    def start_sm_on_rising_edge(self):
        ...
        Returns:
            Nothing.
        """
        ctrl_reg = clr_field(VSR_FPGA_REGISTERS.REG20, "SM_START_EDGE",
    ...
    def start_sm_on_falling_edge(self):
        ...
        Returns:
            Nothing.
        """
        ctrl_reg = set_field(VSR_FPGA_REGISTERS.REG20, "SM_START_EDGE",
                             self._fpga_reg_read(VSR_FPGA_REGISTERS.REG20['addr']), 1)
        self._fpga_reg_write(VSR_FPGA_REGISTERS.REG20['addr'], ctrl_reg)

    def set_dc_control_bits(self, capt_avg_pict=True, vcal_pulse_disable=True, spectroscopic_mode_en=True):
        ...
        if capt_avg_pict:
            ctrl_reg = set_field(VSR_FPGA_REGISTERS.REG36, "CAPT_AVG_PICT", ctrl_reg, 1)
        if vcal_pulse_disable:
            ctrl_reg = set_field(VSR_FPGA_REGISTERS.REG36, "VCAL_PULSE_DISABLE", ctrl_reg, 1)
        if spectroscopic_mode_en:
            ctrl_reg = set_field(VSR_FPGA_REGISTERS.REG36, "SPECTROSCOPIC_MODE_EN", ctrl_reg, 1)
        self._fpga_reg_write(VSR_FPGA_REGISTERS.REG36['addr'], ctrl_reg)

    def clr_dc_control_bits(self, capt_avg_pict=True, vcal_pulse_disable=True, spectroscopic_mode_en=True):
        ...
        ctrl_reg = self._fpga_reg_read(VSR_FPGA_REGISTERS.REG36['addr'])
        if capt_avg_pict:
            ctrl_reg = clr_field(VSR_FPGA_REGISTERS.REG36, "CAPT_AVG_PICT", ctrl_reg)
        if vcal_pulse_disable:
            ctrl_reg = clr_field(VSR_FPGA_REGISTERS.REG36, "VCAL_PULSE_DISABLE", ctrl_reg)
        if spectroscopic_mode_en:
            ctrl_reg = clr_field(VSR_FPGA_REGISTERS.REG36, "SPECTROSCOPIC_MODE_EN", ctrl_reg)
        self._fpga_reg_write(VSR_FPGA_REGISTERS.REG36['addr'], ctrl_reg)
    ...
    def disable_all_columns(self, asic=1):
        ...
        if asic == 2:
            ...
            en_start_addrs = [VSR_FPGA_REGISTERS.REG77['addr'], VSR_FPGA_REGISTERS.REG97['addr']]
        for s_addr in en_start_addrs:
            self._fpga_reg_write_burst(s_addr, clr_row_column_mask(all_elements=True))
    ...
    def disable_sm(self):
        ...
        Returns:
            Nothing.
        """
        ctrl_reg = clr_field(VSR_FPGA_REGISTERS.REG1, "SM_EN",
                             self._fpga_reg_read(VSR_FPGA_REGISTERS.REG1['addr']))
        self._fpga_reg_write(VSR_FPGA_REGISTERS.REG1['addr'], ctrl_reg)
    ...
    def enable_sm(self):
        ...
        Returns:
            Nothing.
        """
        ctrl_reg = set_field(VSR_FPGA_REGISTERS.REG1, "SM_EN",
                             self._fpga_reg_read(VSR_FPGA_REGISTERS.REG1['addr']), 1)
        self._fpga_reg_write(VSR_FPGA_REGISTERS.REG1['addr'], ctrl_reg)
    ...
    def initialise(self):
        ...
        self.init_adc()  # 1216
        self.set_dc_control_bits(capt_avg_pict=True, vcal_pulse_disable=True, spectroscopic_mode_en=False)  # 1226
        ...
        self.clr_dc_control_bits(capt_avg_pict=False, vcal_pulse_disable=True, spectroscopic_mode_en=False)  # 1243
