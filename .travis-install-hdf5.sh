...
if [ ! -d "$RUNNER_WORKSPACE/hexitec-detector/hdf5-1.10.1/lib" ]; then
  ...
  cd hdf5-1.10.1 && ./configure --prefix=$RUNNER_WORKSPACE/hexitec-detector/hdf5-1.10.1 && make -j && make install;
else
